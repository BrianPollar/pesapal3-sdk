...
class Pesapal {
    ...
    async registerIpn(ipn, notificationMethodType = 'GET') {
        ...
        return new Promise((resolve, reject) => {
            this.axiosInstance
                .post('/api/URLSetup/RegisterIPN', parameters, { headers })
                .then(res => {
    ...
    async getIpnEndPoints() {
        ...
        return new Promise((resolve, reject) => {
            this.axiosInstance
                .get('/api/URLSetup/GetIpnList', { headers })
                .then(res => {
                const response = res.data;
    ...
    async submitOrder(paymentDetails, productId, description) {
        ...
        try {
            ...
            // Make API call
            const response = await this.axiosInstance.post('/api/Transactions/SubmitOrderRequest', this.constructParamsFromObj(paymentDetails, productId, description), { headers });
            // Handle response
    ...
    async getTransactionStatus(orderTrackingId) {
        ...
        return new Promise((resolve, reject) => {
            this.axiosInstance
                .get(`/api/Transactions/GetTransactionStatus?orderTrackingId=${orderTrackingId}`, { headers }).then(res => {
                const response = res.data;
                if (response.error) {
    ...
    async refundRequest(refunReqObj) {
        ...
        return new Promise((resolve, reject) => {
            this.axiosInstance
                .post('/api/Transactions/RefundRequestt', refunReqObj, { headers })
                .then(res => {
                const response = res.data;
                if (!response) {
    ...
    getToken() {
        ...
        return new Promise((resolve, reject) => {
            this.axiosInstance
                .post('/api/Auth/RequestToken', parameters, { headers })
                .then(res => {
                const data = res.data;
